var Base_Url = "localhost/national/lga_map_users.php";
 
var pins_config = {
  "pins":[
  {
    "shape": "square",//either "circle" or "square"
    "hover": "<b><u>ABUJA</u></b><br>Write any text and load images<br><img src='example.png'>",//info of the popup
    ...
    "url": Base_Url +"?id=",//link to any webpage
  ...
  {
    "shape": "circle",
    "hover": "<b><u>IBADAN</u></b><br><span style='color: #999;'>Click to open a modal window!</span><br><span style='color: #ff6666;'><b>Modal Window Option is Compatible<br> with Bootstrap Only.</b></span>",
    "pos_X": 93,
    "pos_Y": 407,
    "size": 16,
    "outline": "#660000",
  ...
  {
    "shape": "circle",
    "hover": "<b><u>BENIN CITY</u></b><br><span style='color: #999;'>*Click to open a webpage*</span>",
    "pos_X": 200,
    "pos_Y": 470,
    "size": 14,
    "outline": "#660000",
...
function ngjsAddEvent(id) {
  ...
  if(pins_config.pins[id].active === true){
    ...
    obj.hover(function () {
      jQuery("#ngjstip").show().html(pins_config.pins[id].hover);
