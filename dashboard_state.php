...
if ($_SESSION['user_level'] ==2 ){// drop state selection menu
  ...
  <form method="post" action="dashboard_state.php">
  <table class="table">
      ...
      // Define the query to determine the total number of  registered users:
                    ...
                    if (mysqli_num_rows($r) > 0) { // Available. 
                      ...
                      $new_members = 0;
                       ...
                       // Define the query to determine the total number of  registered users:
                       $q = "SELECT * FROM lga WHERE state_id = $state_code";     
                       $r = @mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                    ...
                    if (mysqli_num_rows($r) > 0) { // Available. 
                      ...
                      $num_lga = 0;
                        ...
                        // Define the query to determine the total number of  registered users:
                       $q = "SELECT * FROM ward  WHERE ward_id LIKE '$state_code-%'";     
                       $r = @mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                    ...
                    if (mysqli_num_rows($r) > 0) { // Available. 
                      ...
                      $num_ward = 0;
                        ...
                        // Define the query to determine the total number of  registered users:
                       $q = "SELECT * FROM polling_unit  WHERE pu_id LIKE '$state_code-%'";     
                       $r = @mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                    ...
                    if (mysqli_num_rows($r) > 0) { // Available. 
                      ...
                      $num_pu = 0;
                        ...
                        // Define the query to determine the total number of  registered users:
                        $q = "SELECT first_name, last_name, phone FROM users WHERE pvc_status ='1' AND state_id = $state_code";     
                        $r = @mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                    ...
                    $q = "SELECT first_name, last_name, phone FROM users WHERE pvc_status ='2' AND state_id = $state_code ";     
                       $r = @mysqli_query ($dbc,$q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                        ...
                        $q = "SELECT first_name, last_name, phone FROM users WHERE state_id = $state_code ";     
                        $r = @mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                       ...
                       $q = "SELECT first_name, last_name, phone FROM users WHERE user_level > 1 AND state_id =$state_code ";     
                       $r = @mysqli_query ($dbc,$q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                       ...
                       $q = "SELECT lga_id FROM users WHERE state_id = $state_code";     
                       $r = @mysqli_query ($dbc,$q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                       ...
                       $q = "SELECT DISTINCT state_id FROM users WHERE state_id = $state_code";     
                       $r = @mysqli_query ($dbc,$q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                       ...
                       $q = "SELECT DISTINCT lga_id FROM users WHERE state_id = $state_code ";     
                       $r = @mysqli_query ($dbc,$q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                       ...
                       $q = "SELECT DISTINCT ward_id FROM users WHERE state_id = $state_code ";     
                       $r = @mysqli_query ($dbc,$q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
                       ...
                       $q = "SELECT DISTINCT pu_id FROM users WHERE state_id = $state_code ";     
                       $r = @mysqli_query ($dbc,$q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc)); // Run the query.
        ...
        <!-- PIE CHART -->
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">State  Statistics</h3>
      ...
      <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-primary">
              ...
              <a href="view_state_member_today.php<?php echo'?id='.$state_code; ?>" class="small-box-footer"> More Info &rarr;<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="lga_users_state.php<?php echo'?id='.$state_code; ?>" class="small-box-footer">More info  <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
