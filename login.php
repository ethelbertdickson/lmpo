...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($e && $p) { // If everything's OK.
        ...
        // Query the database:
        $q = "SELECT * FROM users WHERE email LIKE '%$e%' OR phone LIKE '%$e%' AND pass=SHA1('$p') ";     
        ...
        if (@mysqli_num_rows($r) == 1) { // A match was  made.
            ...
            exit(); // Quit the script.
                 ...
                 echo'<div align= "center" class= "col-md-12">';
                    echo '<h4  class="alert alert-danger"> Oops! Either the email address or password entered do not match those on file or you have not yet activated your account!</h4>';
                 echo'</div></center>';
           }          
                ...
                <div class="styled-form login-form">
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" value="<?php if (isset($trimmed['email'])) echo $trimmed['email']; ?>" required autofocus placeholder="Enter Email Address or Phone Number*">
                        </div>
                        <div class="form-group">
