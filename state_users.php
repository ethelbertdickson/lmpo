...
if (isset($_GET['p']) && is_numeric($_GET['p'])) { // Already been determined.
  ...
  $q = "SELECT COUNT(DISTINCT state_id) FROM users";
...
<tr>
  ...
  <th align="left"><b> Members Registered </b></th>
  <th align="left"><b>View Members</b></th>
...
while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
    ...
    <td align="left"><a href="dashboard_state.php?id=' . $row['id'] . '"><span class="btn btn-success"><i class="fas fa-arrow-right"></i> Goto State Dashboard</span></a></td>
